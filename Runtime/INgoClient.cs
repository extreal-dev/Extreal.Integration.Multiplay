...
namespace Extreal.Integration.Multiplay.NGO
{
    ...
    public interface INgoClient : IDisposable
    {
        ...
        /// </summary>
        IObservable<Unit> OnApprovalRejected { get; }
        ...
        void SetNetworkTransportConfiger(INetworkTransportConfiger networkTransportConfiger);
        ...
        UniTask ConnectAsync(ConnectionConfig connectionConfig, CancellationToken token = default);
